...
const initGitHubProjects = () => {
  // GitHub username
  const GITHUB_USERNAME = "Amine-Mb";
  ...
  if (GITHUB_USERNAME === "YOUR_GITHUB_USERNAME") {
    loadingEl.innerHTML =
      '<p style="opacity: 0.6;">Add your GitHub username in script.js to display projects</p>';
    return;
  }
  ...
  fetch(GITHUB_API_URL)
    ...
    .then((repos) => {
      ...
      if (repos.length === 0) {
        projectsGrid.innerHTML =
          '<p style="text-align: center; opacity: 0.6;">No repositories found</p>';
        return;
      }
    ...
    .catch((error) => {
      ...
      loadingEl.innerHTML =
        '<p style="color: var(--color-red);">Failed to load projects. Please check your GitHub username.</p>';
    });
};
    ...
    <div class="github-project-card__header">
      ...
      <div class="github-project-card__meta">
        ...
        <div class="github-project-card__stats">
          <span class="github-project-card__star">⭐ ${
            repo.stargazers_count || 0
          }</span>
          <span class="github-project-card__fork">🍴 ${
            repo.forks_count || 0
          }</span>
        </div>
      </div>
